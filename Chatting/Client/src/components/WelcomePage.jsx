...
//       const storedData = await JSON.parse(localStorage.getItem(process.env.REACT_APP_KEY));
...
//       <WelcomePageMessage>
//         WelcomePage, <UserName>{userName}!</UserName>
//       </WelcomePageMessage>
...
// const WelcomePageMessage = styled.h1`
//   span {
//     color: green;
//   }
// `;
